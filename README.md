...
如需留存证据，可在同一次登录网页会话中分别截取上述三处，并记录截图时间、筛选项和登录状态。截图适合作为本地调研材料；公开仓库只保留“案例 D（资料 API 4,054、高级搜索实际 904、旧时间线实际 1,898、并集 1,907）”这类匿名描述，不提交包含真实账号名称、UID、正文或 Cookie 的截图。
